...
<pre name="f618" id="f618" class="graf graf--pre graf-after--p"># Take out the 

After we have the tag, we can get the data by getting its `text`.

<pre name="5bbc" id="5bbc" class="graf graf--pre graf-after--p">name = name_box.text.strip() # strip() is used to remove starting and trailing  
print name</pre>

Similarly, we can get the price too.

<pre name="bbb5" id="bbb5" class="graf graf--pre graf-after--p"># get the index price  
...
<pre name="5f42" id="5f42" class="graf graf--pre graf-after--p">import csv  
from datetime import datetime</pre>

At the bottom of your code, add the code for writing data to a csv file.

<pre name="c456" id="c456" class="graf graf--pre graf-after--p"># open a csv file with append, so old data will not be erased  
