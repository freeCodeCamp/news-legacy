...
coverSrc: https://cdn-images-1.medium.com/max/1024/1*jju0KT50kJI1xX6c6EJVsw.png
url: https://medium.freecodecamp.org/do-you-want-to-learn-more-about-react-lets-build-and-then-play-a-game-218e0da5be44?source=rss----336d898217ee---4
id: https://medium.com/p/218e0da5be44
date: Fri, 17 Nov 2017 13:27:48 GMT
---
...
![](https://cdn-images-1.medium.com/max/1024/1*jju0KT50kJI1xX6c6EJVsw.png)

<figcaption>The Target Sum Game: Pick the set of challenge numbers that sum to the target 42 within 10 seconds</figcaption>
...
<iframe src="https://cdn.embedly.com/widgets/media.html?url=https%3A%2F%2Fjscomplete.com%2Frepl%2F%3Fj%3Dpreview-rJj8poQyM&amp;src=https%3A%2F%2Fjscomplete.com%2Fp%2FrJj8poQyM%2Fembed%3Fpreview%3D1&amp;type=text%2Fhtml&amp;key=a19fcc184b9711e1b4764040d3dc5c07&amp;schema=jscomplete" width="600" height="400" frameborder="0" scrolling="no"><a href="https://medium.com/media/8a93f032b875ee96a0d710ef0067f1db/href">https://medium.com/media/8a93f032b875ee96a0d710ef0067f1db/href</a></iframe>
...
<iframe src="https://cdn.embedly.com/widgets/media.html?url=https%3A%2F%2Fjscomplete.com%2Frepl%2F%3Fj%3DHkGgHj7kM&amp;src=https%3A%2F%2Fjscomplete.com%2Fp%2FHkGgHj7kM%2Fembed&amp;type=text%2Fhtml&amp;key=a19fcc184b9711e1b4764040d3dc5c07&amp;schema=jscomplete" width="800" height="250" frameborder="0" scrolling="no"><a href="https://medium.com/media/998fc7667fabcc4e355da1b8b2a3e00d/href">https://medium.com/media/998fc7667fabcc4e355da1b8b2a3e00d/href</a></iframe>
...
<pre>// Step #2: [https://jscomplete.com/repl/?j=S1M0BsQ1G](https://jscomplete.com/repl/?j=S1M0BsQ1G)</pre>

<pre>**class Number extends React.Component {
  render() {
    return <div className="number">{this.props.value}</div>;
  }
}**</pre>

<pre>class Game extends React.Component {
  render() {
    return (
      <div className="game">
...
<pre>ReactDOM.render(<Game />, document.getElementById('mountNode'));</pre>
...
<pre>// Top-level function</pre>

<pre>**const randomNumberBetween = (min, max) =>
...
<pre><Game **challengeSize={6}** **challengeRange={[2, 9]}** /></pre>
...
Passing anything else to the Cell component will make it re-render unnecessarily, which is something we should avoid.
...
<pre>// In the Number component</pre>
...
<pre>**calcGameStatus = (selectedIds) => {
...
<pre>// Create new App component</pre>
...
<pre>// In the Game class: respect the value of the new autoPlay prop
 **componentDidMount() {
...
![](https://cdn-images-1.medium.com/max/1024/1*Gun2dDDh21wbMyBmPkJIIQ.png)

<figcaption>The Number component was re-rendered 66 times. How many of these were necessary?</figcaption>
...
![](https://cdn-images-1.medium.com/max/1024/1*JB4ahRqp1hWKGr1LvbjsoQ.png)

<figcaption>36 Number component updates happened when only 9 updates should have happened</figcaption>
...
<pre>class Number extends **React.PureComponent**</pre>

![](https://cdn-images-1.medium.com/max/1024/1*zz5qM2QVa_7ZrRmuXC2a9A.png)

<figcaption>Exactly ten Number components were updated (initial six + the selected four)</figcaption>
...
[![](https://cdn-images-1.medium.com/max/360/1*HNs-H8HXZ5WDFq7RXYMqFw.png)](https://jscomplete.com/learn-react-js-by-building-simple-games)

<figcaption>[https://jscomplete.com/learn-react-js-by-building-simple-games](https://jscomplete.com/learn-react-js-by-building-simple-games)</figcaption>



<iframe src="https://cdn.embedly.com/widgets/media.html?url=https%3A%2F%2Fjscomplete.com%2Frepl%2F%3Fj%3Dpreview-B1Imo-r1M&amp;src=https%3A%2F%2Fjscomplete.com%2Fp%2FB1Imo-r1M%2Fembed%3Fpreview%3D1&amp;type=text%2Fhtml&amp;key=a19fcc184b9711e1b4764040d3dc5c07&amp;schema=jscomplete" width="600" height="400" frameborder="0" scrolling="no"><a href="https://medium.com/media/f84ef192a30e1d65b1960de6d2e6c27c/href">https://medium.com/media/f84ef192a30e1d65b1960de6d2e6c27c/href</a></iframe>![](https://medium.com/_/stat?event=post.clientViewed&referrerSource=full_rss&postId=218e0da5be44)

* * *

[Do you want to learn more about React? Let’s build — and then play — a game.](https://medium.freecodecamp.org/do-you-want-to-learn-more-about-react-lets-build-and-then-play-a-game-218e0da5be44) was originally published in [freeCodeCamp](https://medium.freecodecamp.org) on Medium, where people are continuing the conversation by highlighting and responding to this story.
