          ...
          <div className='flexSpaceAround'>
            <Col className='flexSpaceAround' sm={4}>
              <a
                ...
                target='_blank'
                >
                <FontAwesome className='browserIcon' name='edge' size='4x' />
              </a>
            </Col>
            <Col className='flexSpaceAround' sm={4}>
              <a
                ...
                target='_blank'
                >
                <FontAwesome className='browserIcon' name='chrome' size='4x' />
              </a>
            </Col>
            <Col className='flexSpaceAround' sm={4}>
              <a
                ...
                target='_blank'
                >
                <FontAwesome className='browserIcon' name='firefox' size='4x' />
              </a>
            </Col>
          </div>
        </Row>
